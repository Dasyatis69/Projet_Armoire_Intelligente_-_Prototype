...
def setup():
    ...
    order_list_for_demo = [
        core.Order('aaaa', [  # commande n°1
            core.Packet(packet_type='AAAA', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='AAAA', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='DDDD', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0))
                        ]),
        core.Order('bbbb', [  # commande n°2
            core.Packet(packet_type='AAAA', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='BBBB', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='CCCC', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='CCCC', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='JJJJ', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0))]),
        core.Order('cccc', [  # commande n°3
            core.Packet(packet_type='EEEE', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='FFFF', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='GGGG', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='IIII', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='HHHH', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0)),
            core.Packet(packet_type='EEEE', absolute_dimension=core.Coordinate(0, 0, 0),
                        real_dimension=core.Coordinate(0, 0, 0))
        ])
...
def wait_for_packet_placeholder(packet_type):  # for simulation purpose
    # sleep(0.1)
    return core.Packet(packet_type=packet_type, absolute_dimension=core.Coordinate(0, 0, 0),
                       real_dimension=core.Coordinate(0, 0, 0))
